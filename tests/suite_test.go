...
var _ = SynchronizedBeforeSuite(
	func() []byte {
		...
		if _, err := os.Stat("/opt/resource/in"); err == nil {
			...
			b.In, err = gexec.Build("github.com/RachelW258/gitlab-merge-request-resource/in/cmd")
		...
		if _, err := os.Stat("/opt/resource/out"); err == nil {
			...
			b.Out, err = gexec.Build("github.com/RachelW258/gitlab-merge-request-resource/out/cmd")
			Expect(err).ToNot(HaveOccurred())
		}
		...
		if _, err := os.Stat("/opt/resource/check"); err == nil {
			...
			b.Check, err = gexec.Build("github.com/RachelW258/gitlab-merge-request-resource/check/cmd")
			Expect(err).ToNot(HaveOccurred())
		}
